...
# =====================================================================
def verificar_fermat(a, b, c, n=4):
    # CAMBIO 1: 'n' ahora es parámetro con valor por defecto, antes estaba fijo.
    # CAMBIO 2: Se eliminó el 'if n > 2' redundante (siempre era True con n=4).
    # CAMBIO 3: Se usa math.pow() en lugar de '**' para hacerlo más profesional.
